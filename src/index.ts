...
function getNextSiblings(elem: {}, adapter: InternalAdapter) {
...
function appendNextSiblings(elem: Array<{}> | {}, adapter: InternalAdapter) {
...
export const selectAll = getSelectorFunc(
    (query, elems: Array<{}>, options: InternalOptions) =>
