...
export const pseudos = {
    empty(elem: {}, adapter: InternalAdapter): boolean {
    ...
    "first-child"(elem: {}, adapter: InternalAdapter): boolean {
        return getFirstElement(adapter.getSiblings(elem), adapter) === elem;
    },
    "last-child"(elem: {}, adapter: InternalAdapter): boolean {
        const siblings = adapter.getSiblings(elem);
    ...
    "first-of-type"(elem: {}, adapter: InternalAdapter): boolean {
        const siblings = adapter.getSiblings(elem);
    ...
    "last-of-type"(elem: {}, adapter: InternalAdapter): boolean {
        const siblings = adapter.getSiblings(elem);
    ...
    "only-of-type"(elem: {}, adapter: InternalAdapter): boolean {
        const siblings = adapter.getSiblings(elem);
    ...
    "only-child"(elem: {}, adapter: InternalAdapter): boolean {
        const siblings = adapter.getSiblings(elem);
    ...
    link(elem: {}, adapter: InternalAdapter): boolean {
    ...
    selected(elem: {}, adapter: InternalAdapter): boolean {
    ...
    //)
    disabled(elem: {}, adapter: InternalAdapter): boolean {
        return adapter.hasAttrib(elem, "disabled");
    },
    enabled(elem: {}, adapter: InternalAdapter): boolean {
        return !adapter.hasAttrib(elem, "disabled");
    },
    //:matches(:matches(:radio, :checkbox)[checked], :selected) (TODO menuitem)
    checked(elem: {}, adapter: InternalAdapter): boolean {
        return (
    ...
    required(elem: {}, adapter: InternalAdapter): boolean {
        return adapter.hasAttrib(elem, "required");
    },
    //:matches(input, select, textarea):not([required])
    optional(elem: {}, adapter: InternalAdapter): boolean {
        return !adapter.hasAttrib(elem, "required");
    },
    ...
    //:not(:empty)
    parent(elem: {}, adapter: InternalAdapter): boolean {
    ...
    button(elem: {}, adapter: InternalAdapter): boolean {
    ...
    text(elem: {}, adapter: InternalAdapter): boolean {
        let attr;
        return (
...
function namePseudo(names: string[]) {
    if (typeof Set !== "undefined") {
        ...
        return (elem: {}, adapter: InternalAdapter) =>
